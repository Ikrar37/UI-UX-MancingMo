...
// Product Images Array (4 images)
const productImages = [
    '/image/Umpan 1:1.jpeg',
    '/image/Umpan 1:2.jpeg',
    '/image/Umpan 1:3.jpeg',
    '/image/Umpan 1:4.jpeg'
];
...
function addToCart() {
    if (!selectedSize) {
        alert('Silakan pilih warna umpan terlebih dahulu!');
        return;
    }
