...
// Product Images Array - GANTI dengan gambar produk yang sesuai
const productImages = [
    '/image/Joran 1:1.jpeg',
    '/image/Joran 1:2.jpeg',
    '/image/Joran 1:3.jpeg'
];
...
function addToCart() {
    ...
    const productImage = productImages[0]; // Use first image for cart
